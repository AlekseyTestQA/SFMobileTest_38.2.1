...
public class AndroidNoValidLoginObject extends MainPageObject implements INoValidLoginObject {
    ...
    final static String RESULT_ELEMENT_BY_TEXT_TPL = "xpath://*[./*[contains(@text,'Incorrect username')]]";

    public AndroidNoValidLoginObject(RemoteWebDriver driver) {
        super(driver);
    }
    ...
    public void selectByTextResultLogin (String text) {
        WebElement expectedResult = this.waitForElementPresent(
                ...
                "Cannot find result: 'Incorrect username'"
        );
    ...
    private static String getResultElementByText(String text) {
        return RESULT_ELEMENT_BY_TEXT_TPL.replace("Incorrect username", text);
    }
}
